...
/**
 * Java File. Title : HhbtMvcConfig.java. Description : This config class
 * used for controllers to configuring the view resolver, resource
 * handlers. Copyright : ENGX-TechBullets (c) 2016 Company : EPAM
 * Solutions.
 *
 * @author : rvaddi
 * @version : 0.1
