...
/**
 * Java File. Title : HhbtAppInitializer.java. Description : This
 * Initializer class used for configuring the servlet mvc config, filter
 * and mapping information. Calls the app, jpa config classes to configure
 * those information. Copyright : ENGX-TechBullets (c) 2016 Company : EPAM
 * Solutions.
 *
 * @author : rvaddi
 * @version : 0.1
...
public class HhbtAppInitializer extends
    ...
    public final void customizeRegistration(
        ...
        final MultipartConfigElement multipartConfigElement =
                new MultipartConfigElement(null, maxUploadSizeInMb,
    ...
    protected Class<?>[] getRootConfigClasses() {
        return new Class<?>[] { HhbtAppConfig.class, HhbtJPAConfig.class };
    }
    ...
    protected Class<?>[] getServletConfigClasses() {
        return new Class<?>[] { HhbtMvcConfig.class };
    }
